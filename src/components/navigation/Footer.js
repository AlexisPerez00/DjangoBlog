const navigation = {
    ...
    social: [
      {
        name: 'Facebook',
        href: 'https://www.facebook.com/profile.php?id=100007928505471',
        icon: (props) => (
      ...
      {
        name: 'Instagram',
        href: 'https://www.instagram.com/alexis_perez0207/',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
      ...
      {
        name: 'GitHub',
        href: 'https://github.com/AlexisPerez00/',
        icon: (props) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
            <path
              fillRule="evenodd"
      ...
      {
        name: 'Linkedin',
        href: 'https://www.linkedin.com/in/alexis-p%C3%A9rez-a56002230/',
        icon: (props) => (
